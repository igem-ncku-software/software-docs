...
預設為 html  
**官方教學** <https://quarto.org/docs/get-started/authoring/vscode.html>
...
**GFM(GitHub Flavored Markdown) 格式**  
format: gfm
...
![](quarto-tutorial_files/figure-commonmark/cell-3-output-1.png)
